...
import {
    BoxGeometry, CircleGeometry, Color, DoubleSide, Euler, LineBasicMaterial, Mesh,
    MeshBasicMaterial,
...
export class FLTransformControlsGizmo extends Object3D {
    ...
    private _init = (object: Object3D): void => {
        ...
        const _renderPoints = (control: ControlType, boxVertex: Vector3[]): [
            points: [tl: Vector3, tr: Vector3, bl: Vector3, br: Vector3, rotate: Vector3 | undefined],
        ...
        const _gizom: { [name: string]: _BaseGizItemSet[] } = {
            ...
            R_POINT: points[4] ? [_PointMesh(points[4], rotation, matWhiteTransparent.clone())] : []
        };
